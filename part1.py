...
randlist = [] #name your list and make sure it is empty!
...
for i in range(10): #for loop appends 5 numbers to your list, but make sure you name your variable
    randlist.append(randint(1,50)) #this adds a random number between 1-50 to the list


print(randlist) #print the list!
